abstract class OfficeSearchFiltersState {
  ...
  const OfficeSearchFiltersState({
...
class OfficeSearchFiltersInitial extends OfficeSearchFiltersState {
  const OfficeSearchFiltersInitial()
    : super(
        searchText: '',
        minPrice: '',
        maxPrice: '',
...
class OfficeSearchFiltersUpdated extends OfficeSearchFiltersState {
  ...
  OfficeSearchFiltersUpdated copyWith({
    String? searchText,
    int? propertyTypeId,
    ...
    return OfficeSearchFiltersUpdated(
